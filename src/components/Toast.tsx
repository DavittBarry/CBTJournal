...
export function ToastContainer() {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 lg:left-[calc(50%+8rem)] z-[100] flex flex-col gap-2 max-w-sm w-full px-4">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={`flex items-start gap-3 p-4 rounded-xl border shadow-soft-lg dark:shadow-soft-lg-dark animate-fade-in ${typeStyles[toast.type]}`}
        >
