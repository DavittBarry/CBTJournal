...
const scoreLabels = ['Not at all', 'Somewhat', 'Moderately', 'A lot', 'Extremely']
...
export function ChecklistDetailView() {
  const { depressionChecklists, selectedChecklistId, setView, setSelectedChecklistId } = useAppStore()
